...
class MerchantReportController extends Controller
{
     ...
     *
     * Returns daily revenue for the authenticated user's merchant.
     * Defaults to November if no month/year query params are provided.
     *
     * Query Params:
    ...
    public function index(Request $request)
    {
        ...
        // Multi-tenancy: merchant_id is injected by MultiTenancyMiddleware
        $merchantId = $request->attributes->get('merchant_id');
        $month      = (int) $request->query('month', 11);
